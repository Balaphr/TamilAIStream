...
// ============================================
function _openApplicationInRightPanel() {
    const panelBody = document.getElementById('rightPanelBody');
    if (!panelBody) return;

    const s = DataStore.getApplication() || {};

    function sel(field, def) {
        const val = s[field] !== undefined ? s[field] : def;
        return val === 'true' || val === true;
    }
    function val(field, def) { return s[field] !== undefined ? s[field] : def; }
    function opt(selected, value) { return selected == value ? ' selected' : ''; }

    const html = `
    <div class="app-settings-panel">
        <!-- App Identity -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-tag"></i> App Identity <span class="app-section-badge">Core</span></div>
            <div class="form-group"><label class="form-label">App Name</label><input type="text" class="form-input" id="appAppName" placeholder="Tamil AI Stream" data-app-field="appName" value="${val('appName','Tamil AI Stream')}"></div>
            <div class="form-group"><label class="form-label">Short Name</label><input type="text" class="form-input" id="appShortName" placeholder="TAIS" maxlength="12" data-app-field="shortName" value="${val('shortName','TAIS')}"></div>
            <div class="form-group"><label class="form-label">Description</label><input type="text" class="form-input" id="appDescription" placeholder="Tamil music streaming app" data-app-field="description" value="${val('description','')}"></div>
            <div class="form-group"><label class="form-label">Version</label><input type="text" class="form-input" id="appVersion" placeholder="1.0.0" data-app-field="version" value="${val('version','1.0.0')}"></div>
            <div class="form-group"><label class="form-label">Package Name</label><input type="text" class="form-input" id="appPackageName" placeholder="com.tamilaistream.app" data-app-field="packageName" value="${val('packageName','')}"></div>
            <div class="form-group"><label class="form-label">Website URL</label><input type="url" class="form-input" id="appWebsiteUrl" placeholder="https://tamilaistream.com" data-app-field="websiteUrl" value="${val('websiteUrl',window.location.origin)}"></div>
        </div>

        <!-- App Icon & Logo -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-image"></i> Icon & Logo <span class="app-section-badge">Branding</span></div>
            <div class="form-group"><label class="form-label">App Icon (512x512)</label>
                <div class="app-icon-upload"><div class="app-icon-preview" id="appIconPreview"><i class="fas fa-mobile-screen-button"></i></div>
                <input type="file" id="appIconFile" accept="image/png,image/jpeg" class="app-file-input" data-app-field="icon"><button type="button" class="builder-btn small" onclick="document.getElementById('appIconFile').click()">Choose</button></div>
            </div>
            <div class="form-group"><label class="form-label">Splash Logo</label>
                <div class="app-icon-upload"><div class="app-icon-preview" id="appSplashLogoPreview"><i class="fas fa-play-circle"></i></div>
                <input type="file" id="appSplashLogoFile" accept="image/png,image/jpeg" class="app-file-input" data-app-field="splashLogo"><button type="button" class="builder-btn small" onclick="document.getElementById('appSplashLogoFile').click()">Choose</button></div>
            </div>
            <div class="form-group"><label class="form-label">Favicon</label>
                <div class="app-icon-upload"><div class="app-icon-preview small" id="appFaviconPreview"><i class="fas fa-star"></i></div>
                <input type="file" id="appFaviconFile" accept="image/png,image/jpeg" class="app-file-input" data-app-field="favicon"><button type="button" class="builder-btn small" onclick="document.getElementById('appFaviconFile').click()">Choose</button></div>
            </div>
            <div class="form-group"><label class="form-label">Maskable Icon</label>
                <div class="app-icon-upload"><div class="app-icon-preview" id="appMaskablePreview"><i class="fas fa-expand"></i></div>
                <input type="file" id="appMaskableFile" accept="image/png" class="app-file-input" data-app-field="maskableIcon"><button type="button" class="builder-btn small" onclick="document.getElementById('appMaskableFile').click()">Choose</button></div>
            </div>
        </div>

        <!-- Splash Screen -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-rocket"></i> Splash Screen <span class="app-section-badge">Startup</span></div>
            <div class="form-group"><label class="form-label">Enable</label><select class="form-input" id="appSplashEnabled" data-app-field="splashEnabled"><option value="true"${opt(sel('splashEnabled',true),'true')}>Enabled</option><option value="false"${opt(sel('splashEnabled',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Duration (ms)</label><input type="number" class="form-input" id="appSplashDuration" min="1000" max="5000" step="100" data-app-field="splashDuration" value="${val('splashDuration',2500)}"></div>
            <div class="form-group"><label class="form-label">Background Color</label><input type="color" class="form-input app-color-input" id="appSplashBgColor" data-app-field="splashBgColor" value="${val('splashBgColor','#080c1c')}"></div>
            <div class="form-group"><label class="form-label">Animation</label><select class="form-input" id="appSplashAnimation" data-app-field="splashAnimation"><option value="fade"${opt(val('splashAnimation','fade'),'fade')}>Fade In</option><option value="scale"${opt(val('splashAnimation','fade'),'scale')}>Scale Up</option><option value="slide"${opt(val('splashAnimation','fade'),'slide')}>Slide Up</option><option value="pulse"${opt(val('splashAnimation','fade'),'pulse')}>Pulse</option></select></div>
            <div class="form-group"><label class="form-label">Show Loading Bar</label><select class="form-input" id="appSplashLoadingBar" data-app-field="splashLoadingBar"><option value="true"${opt(sel('splashLoadingBar',true),'true')}>Yes</option><option value="false"${opt(sel('splashLoadingBar',true),'false')}>No</option></select></div>
            <div class="form-group"><label class="form-label">Show App Name</label><select class="form-input" id="appSplashShowName" data-app-field="splashShowName"><option value="true"${opt(sel('splashShowName',true),'true')}>Yes</option><option value="false"${opt(sel('splashShowName',true),'false')}>No</option></select></div>
        </div>

        <!-- Theme -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-palette"></i> Theme <span class="app-section-badge">Appearance</span></div>
            <div class="form-group"><label class="form-label">Mode</label><select class="form-input" id="appThemeMode" data-app-field="themeMode"><option value="dark"${opt(val('themeMode','dark'),'dark')}>Dark</option><option value="light"${opt(val('themeMode','dark'),'light')}>Light</option><option value="system"${opt(val('themeMode','dark'),'system')}>Follow System</option></select></div>
            <div class="form-group"><label class="form-label">Primary Color</label><input type="color" class="form-input app-color-input" id="appPrimaryColor" data-app-field="primaryColor" value="${val('primaryColor','#22d3ee')}"></div>
            <div class="form-group"><label class="form-label">Accent Color</label><input type="color" class="form-input app-color-input" id="appAccentColor" data-app-field="accentColor" value="${val('accentColor','#34d399')}"></div>
            <div class="form-group"><label class="form-label">Background</label><input type="color" class="form-input app-color-input" id="appBgColor" data-app-field="bgColor" value="${val('bgColor','#080c1c')}"></div>
            <div class="form-group"><label class="form-label">Status Bar</label><select class="form-input" id="appStatusBar" data-app-field="statusBarStyle"><option value="dark"${opt(val('statusBarStyle','dark'),'dark')}>Dark</option><option value="light"${opt(val('statusBarStyle','dark'),'light')}>Light</option></select></div>
            <div class="form-group"><label class="form-label">Nav Bar Color</label><input type="color" class="form-input app-color-input" id="appNavBarColor" data-app-field="navBarColor" value="${val('navBarColor','#0a0e1a')}"></div>
        </div>

        <!-- Home Layout -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-house"></i> Home Layout <span class="app-section-badge">Layout</span></div>
            <div class="form-group"><label class="form-label">Style</label><select class="form-input" id="appHomeStyle" data-app-field="homeStyle"><option value="standard"${opt(val('homeStyle','standard'),'standard')}>Standard</option><option value="minimal"${opt(val('homeStyle','standard'),'minimal')}>Minimal</option><option value="grid"${opt(val('homeStyle','standard'),'grid')}>Grid Focus</option></select></div>
            <div class="form-group"><label class="form-label">Hero Carousel</label><select class="form-input" id="appShowHero" data-app-field="showHero"><option value="true"${opt(sel('showHero',true),'true')}>Yes</option><option value="false"${opt(sel('showHero',true),'false')}>No</option></select></div>
            <div class="form-group"><label class="form-label">FM Section</label><select class="form-input" id="appShowFm" data-app-field="showFm"><option value="true"${opt(sel('showFm',true),'true')}>Yes</option><option value="false"${opt(sel('showFm',true),'false')}>No</option></select></div>
            <div class="form-group"><label class="form-label">Recently Added</label><select class="form-input" id="appShowRecent" data-app-field="showRecent"><option value="true"${opt(sel('showRecent',true),'true')}>Yes</option><option value="false"${opt(sel('showRecent',true),'false')}>No</option></select></div>
            <div class="form-group"><label class="form-label">AI Recommendations</label><select class="form-input" id="appShowAiRec" data-app-field="showAiRec"><option value="true"${opt(sel('showAiRec',true),'true')}>Yes</option><option value="false"${opt(sel('showAiRec',true),'false')}>No</option></select></div>
            <div class="form-group"><label class="form-label">Playlists</label><select class="form-input" id="appShowPlaylists" data-app-field="showPlaylists"><option value="true"${opt(sel('showPlaylists',true),'true')}>Yes</option><option value="false"${opt(sel('showPlaylists',true),'false')}>No</option></select></div>
        </div>

        <!-- Bottom Navigation -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-bars"></i> Bottom Nav <span class="app-section-badge">Navigation</span></div>
            <div class="form-group"><label class="form-label">Home</label><select class="form-input" id="appNavHome" data-app-field="navHome"><option value="true"${opt(sel('navHome',true),'true')}>Visible</option><option value="false"${opt(sel('navHome',true),'false')}>Hidden</option></select></div>
            <div class="form-group"><label class="form-label">FM / Radio</label><select class="form-input" id="appNavFm" data-app-field="navFm"><option value="true"${opt(sel('navFm',true),'true')}>Visible</option><option value="false"${opt(sel('navFm',true),'false')}>Hidden</option></select></div>
            <div class="form-group"><label class="form-label">Music</label><select class="form-input" id="appNavMusic" data-app-field="navMusic"><option value="true"${opt(sel('navMusic',true),'true')}>Visible</option><option value="false"${opt(sel('navMusic',true),'false')}>Hidden</option></select></div>
            <div class="form-group"><label class="form-label">Search</label><select class="form-input" id="appNavSearch" data-app-field="navSearch"><option value="true"${opt(sel('navSearch',true),'true')}>Visible</option><option value="false"${opt(sel('navSearch',true),'false')}>Hidden</option></select></div>
            <div class="form-group"><label class="form-label">Account</label><select class="form-input" id="appNavAccount" data-app-field="navAccount"><option value="true"${opt(sel('navAccount',true),'true')}>Visible</option><option value="false"${opt(sel('navAccount',true),'false')}>Hidden</option></select></div>
            <div class="form-group"><label class="form-label">Style</label><select class="form-input" id="appNavStyle" data-app-field="navStyle"><option value="icons"${opt(val('navStyle','icons'),'icons')}>Icons + Labels</option><option value="icons-only"${opt(val('navStyle','icons'),'icons-only')}>Icons Only</option><option value="labels"${opt(val('navStyle','icons'),'labels')}>Labels Only</option></select></div>
        </div>

        <!-- Player -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-headphones"></i> Player <span class="app-section-badge">Playback</span></div>
            <div class="form-group"><label class="form-label">Full Screen</label><select class="form-input" id="appFullScreenPlayer" data-app-field="fullScreenPlayer"><option value="true"${opt(sel('fullScreenPlayer',true),'true')}>Enabled</option><option value="false"${opt(sel('fullScreenPlayer',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Background Audio</label><select class="form-input" id="appBgAudio" data-app-field="bgAudio"><option value="true"${opt(sel('bgAudio',true),'true')}>Enabled</option><option value="false"${opt(sel('bgAudio',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Lock Screen</label><select class="form-input" id="appLockScreen" data-app-field="lockScreenControls"><option value="true"${opt(sel('lockScreenControls',true),'true')}>Enabled</option><option value="false"${opt(sel('lockScreenControls',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Mini Player</label><select class="form-input" id="appMiniPlayer" data-app-field="miniPlayer"><option value="true"${opt(sel('miniPlayer',true),'true')}>Enabled</option><option value="false"${opt(sel('miniPlayer',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Sleep Timer</label><select class="form-input" id="appSleepTimer" data-app-field="sleepTimer"><option value="true"${opt(sel('sleepTimer',true),'true')}>Enabled</option><option value="false"${opt(sel('sleepTimer',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Audio Quality</label><select class="form-input" id="appAudioQuality" data-app-field="audioQuality"><option value="auto"${opt(val('audioQuality','auto'),'auto')}>Auto</option><option value="high"${opt(val('audioQuality','auto'),'high')}>High</option><option value="medium"${opt(val('audioQuality','auto'),'medium')}>Medium</option><option value="low"${opt(val('audioQuality','auto'),'low')}>Low</option></select></div>
        </div>

        <!-- Notifications -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-bell"></i> Notifications <span class="app-section-badge">Engagement</span></div>
            <div class="form-group"><label class="form-label">Enable</label><select class="form-input" id="appNotifications" data-app-field="notifications"><option value="true"${opt(sel('notifications',true),'true')}>Enabled</option><option value="false"${opt(sel('notifications',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">New Release Alerts</label><select class="form-input" id="appNewReleaseAlert" data-app-field="newReleaseAlert"><option value="true"${opt(sel('newReleaseAlert',true),'true')}>Enabled</option><option value="false"${opt(sel('newReleaseAlert',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Recommendation Push</label><select class="form-input" id="appRecPush" data-app-field="recPush"><option value="true"${opt(sel('recPush',true),'true')}>Enabled</option><option value="false"${opt(sel('recPush',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">FM Live Alerts</label><select class="form-input" id="appFmAlert" data-app-field="fmAlert"><option value="true"${opt(sel('fmAlert',true),'true')}>Enabled</option><option value="false"${opt(sel('fmAlert',true),'false')}>Disabled</option></select></div>
        </div>

        <!-- Auth -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-lock"></i> Authentication <span class="app-section-badge">Security</span></div>
            <div class="form-group"><label class="form-label">Enable Login</label><select class="form-input" id="appLoginEnabled" data-app-field="loginEnabled"><option value="true"${opt(sel('loginEnabled',true),'true')}>Enabled</option><option value="false"${opt(sel('loginEnabled',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Google Sign-In</label><select class="form-input" id="appGoogleLogin" data-app-field="googleLogin"><option value="true"${opt(sel('googleLogin',true),'true')}>Enabled</option><option value="false"${opt(sel('googleLogin',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Email/Password</label><select class="form-input" id="appEmailLogin" data-app-field="emailLogin"><option value="true"${opt(sel('emailLogin',true),'true')}>Enabled</option><option value="false"${opt(sel('emailLogin',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Guest Mode</label><select class="form-input" id="appGuestMode" data-app-field="guestMode"><option value="true"${opt(sel('guestMode',true),'true')}>Enabled</option><option value="false"${opt(sel('guestMode',true),'false')}>Disabled</option></select></div>
        </div>

        <!-- App Settings -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-gear"></i> App Settings <span class="app-section-badge">General</span></div>
            <div class="form-group"><label class="form-label">Downloads</label><select class="form-input" id="appAllowDownloads" data-app-field="allowDownloads"><option value="true"${opt(sel('allowDownloads',false),'true')}>Enabled</option><option value="false"${opt(sel('allowDownloads',false),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Offline Mode</label><select class="form-input" id="appOfflineMode" data-app-field="offlineMode"><option value="true"${opt(sel('offlineMode',true),'true')}>Enabled</option><option value="false"${opt(sel('offlineMode',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Share Button</label><select class="form-input" id="appShareButton" data-app-field="shareButton"><option value="true"${opt(sel('shareButton',true),'true')}>Enabled</option><option value="false"${opt(sel('shareButton',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Analytics</label><select class="form-input" id="appAnalytics" data-app-field="analytics"><option value="true"${opt(sel('analytics',true),'true')}>Enabled</option><option value="false"${opt(sel('analytics',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Cache Strategy</label><select class="form-input" id="appCacheStrategy" data-app-field="cacheStrategy"><option value="aggressive"${opt(val('cacheStrategy','aggressive'),'aggressive')}>Aggressive</option><option value="balanced"${opt(val('cacheStrategy','aggressive'),'balanced')}>Balanced</option><option value="minimal"${opt(val('cacheStrategy','aggressive'),'minimal')}>Minimal</option></select></div>
            <div class="form-group"><label class="form-label">Auto-Update</label><select class="form-input" id="appAutoUpdate" data-app-field="autoUpdate"><option value="true"${opt(sel('autoUpdate',true),'true')}>Enabled</option><option value="false"${opt(sel('autoUpdate',true),'false')}>Disabled</option></select></div>
        </div>

        <!-- Mobile Responsive -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-mobile-alt"></i> Mobile Display <span class="app-section-badge">Responsive</span></div>
            <div class="form-group"><label class="form-label">Safe Area</label><select class="form-input" id="appSafeArea" data-app-field="safeArea"><option value="true"${opt(sel('safeArea',true),'true')}>Enabled</option><option value="false"${opt(sel('safeArea',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Status Bar Overlay</label><select class="form-input" id="appStatusBarOverlay" data-app-field="statusBarOverlay"><option value="true"${opt(sel('statusBarOverlay',true),'true')}>Enabled</option><option value="false"${opt(sel('statusBarOverlay',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Orientation</label><select class="form-input" id="appLandscape" data-app-field="landscape"><option value="portrait"${opt(val('landscape','portrait'),'portrait')}>Portrait Only</option><option value="both"${opt(val('landscape','portrait'),'both')}>Both</option></select></div>
            <div class="form-group"><label class="form-label">Tablet Layout</label><select class="form-input" id="appTabletLayout" data-app-field="tabletLayout"><option value="responsive"${opt(val('tabletLayout','responsive'),'responsive')}>Responsive</option><option value="compact"${opt(val('tabletLayout','responsive'),'compact')}>Compact</option><option value="expanded"${opt(val('tabletLayout','responsive'),'expanded')}>Expanded</option></select></div>
            <div class="form-group"><label class="form-label">Haptic Feedback</label><select class="form-input" id="appHaptic" data-app-field="haptic"><option value="true"${opt(sel('haptic',true),'true')}>Enabled</option><option value="false"${opt(sel('haptic',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Swipe Gestures</label><select class="form-input" id="appGestures" data-app-field="gestures"><option value="true"${opt(sel('gestures',true),'true')}>Enabled</option><option value="false"${opt(sel('gestures',true),'false')}>Disabled</option></select></div>
        </div>

        <!-- AI Auto Update -->
        <div class="app-rp-section">
            <div class="app-rp-section-title"><i class="fas fa-wand-magic-sparkles"></i> AI Auto Update <span class="app-section-badge">AI</span></div>
            <div class="form-group"><label class="form-label">Optimize Images</label><select class="form-input" id="appAiOptimizeImages" data-app-field="aiOptimizeImages"><option value="true"${opt(sel('aiOptimizeImages',true),'true')}>Enabled</option><option value="false"${opt(sel('aiOptimizeImages',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Smart Caching</label><select class="form-input" id="appAiSmartCache" data-app-field="aiSmartCache"><option value="true"${opt(sel('aiSmartCache',true),'true')}>Enabled</option><option value="false"${opt(sel('aiSmartCache',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Auto-Apply Changes</label><select class="form-input" id="appAiAutoApply" data-app-field="aiAutoApply"><option value="true"${opt(sel('aiAutoApply',true),'true')}>Enabled</option><option value="false"${opt(sel('aiAutoApply',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Perf Monitoring</label><select class="form-input" id="appAiPerfMonitor" data-app-field="aiPerfMonitor"><option value="true"${opt(sel('aiPerfMonitor',true),'true')}>Enabled</option><option value="false"${opt(sel('aiPerfMonitor',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Content Sync</label><select class="form-input" id="appAiContentSync" data-app-field="aiContentSync"><option value="true"${opt(sel('aiContentSync',true),'true')}>Enabled</option><option value="false"${opt(sel('aiContentSync',true),'false')}>Disabled</option></select></div>
            <div class="form-group"><label class="form-label">Update Frequency</label><select class="form-input" id="appAiUpdateFreq" data-app-field="aiUpdateFreq"><option value="realtime"${opt(val('aiUpdateFreq','realtime'),'realtime')}>Real-time</option><option value="5"${opt(val('aiUpdateFreq','realtime'),'5')}>Every 5 min</option><option value="15"${opt(val('aiUpdateFreq','realtime'),'15')}>Every 15 min</option><option value="60"${opt(val('aiUpdateFreq','realtime'),'60')}>Every hour</option></select></div>
        </div>

        <!-- Save Button -->
        <div style="padding:12px 0;border-top:1px solid rgba(255,255,255,0.08);margin-top:8px;">
            <button class="builder-btn primary" style="width:100%;" onclick="AppBuilder.saveApplicationSettings()"><i class="fas fa-save"></i> Save All Settings</button>
        </div>
    </div>`;

    panelBody.innerHTML = html;
    openRightPanel('<i class="fas fa-mobile-screen-button"></i> Application Settings', '');

    // Re-bind field listeners for right panel
