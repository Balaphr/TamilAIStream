...
const DataStore = {
    KEYS: {
        ...
        ENTRANCE_LOGO: 'tamilAIStream_entranceLogo',
    ...
    getEntranceLogo() { return this.get(this.KEYS.ENTRANCE_LOGO) || {}; },
    setEntranceLogo(data) { this.set(this.KEYS.ENTRANCE_LOGO, data); },
...
init() {
        ...
        if (!localStorage.getItem(this.KEYS.SECTION_SETTINGS)) {
            this.setSectionSettings({
                ...
                'ai-one-tap-radio': { enabled: true, order: 3, title: 'One Tap Radio', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 },
                'ai-songs-collections': { enabled: true, order: 4, title: 'Songs Collections', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3, autoScroll: { enabled: true, direction: 'up-down', speed: 18, infinite: true, touch: 'pass-through', click: 'play', hover: 'ignore' } },
                'ai-music-hero': { enabled: true, order: 5, title: '', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 },
                'ai-trending': { enabled: true, order: 6, title: 'Trending', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3, card: { width: 160, height: 0, gap: 12, radius: 14, thumbAspect: '1/1', design: 'standard', animation: 'none', animSpeed: 0.3, hover: 'lift' }, responsive: { mobile: { width: 140, gap: 10, radius: 12 }, tablet: { width: 155, gap: 11, radius: 13 }, desktop: { width: 160, gap: 12, radius: 14 } } },
                'ai-live-fm': { enabled: true, order: 7, title: 'Live FM', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3, card: { width: 160, height: 0, gap: 12, radius: 14, thumbAspect: '1/1', design: 'standard', animation: 'none', animSpeed: 0.3, hover: 'lift' }, responsive: { mobile: { width: 140, gap: 10, radius: 12 }, tablet: { width: 155, gap: 11, radius: 13 }, desktop: { width: 160, gap: 12, radius: 14 } } },
                'ai-evergreen': { enabled: true, order: 8, title: 'Evergreen Classics', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3, card: { width: 160, height: 0, gap: 12, radius: 14, thumbAspect: '1/1', design: 'standard', animation: 'none', animSpeed: 0.3, hover: 'lift' }, responsive: { mobile: { width: 140, gap: 10, radius: 12 }, tablet: { width: 155, gap: 11, radius: 13 }, desktop: { width: 160, gap: 12, radius: 14 } } },
                'ai-decades': { enabled: true, order: 9, title: 'Music by Era', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3, card: { width: 160, height: 0, gap: 12, radius: 14, thumbAspect: '1/1', design: 'standard', animation: 'none', animSpeed: 0.3, hover: 'lift' }, responsive: { mobile: { width: 140, gap: 10, radius: 12 }, tablet: { width: 155, gap: 11, radius: 13 }, desktop: { width: 160, gap: 12, radius: 14 } } },
                'upcoming-new': { enabled: false, order: 10, title: 'Upcoming', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 },
                'ai-new-album': { enabled: false, order: 11, title: 'New Album', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 },
                'ur-auto-slider': { enabled: false, order: 12, title: 'Upcoming Releases', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 },
                'ai-ai-rec': { enabled: false, order: 13, title: 'AI Recommendations', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 },
                'ai-favorites': { enabled: false, order: 14, title: 'Favourites', subtitle: '', topSpacing: 0, bottomSpacing: 0, bg: '', animation: 'none', animationSpeed: 0.3 }
            });
        }
        ...
        // Entrance Logo Settings defaults
        if (!localStorage.getItem(this.KEYS.ENTRANCE_LOGO)) {
            this.setEntranceLogo({
                desktop: {
                    enabled: true,
                    logo: '',
                    brandName: 'Tamil AI Stream',
                    logoSize: 120,
